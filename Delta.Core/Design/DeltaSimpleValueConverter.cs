...
namespace Delta.Serialization
{
    ...
    /// </remarks>
    public sealed class DeltaSimpleValueConverter : ISimpleValueConverter
    {
        ...
        /// </summary>
        public DeltaSimpleValueConverter()
        {
        ...
        public DeltaSimpleValueConverter(CultureInfo cultureInfo, ITypeNameConverter typeNameConverter)
        {
        ...
        public string ConvertToString(object value)
        {
            ...
            if (value is Vector2)
            {
                return Vector2Extensions.ToString((Vector2)value);
            }

            if (value is Vector3)
            {
                return Vector2Extensions.ToString((Vector3)value);
            }
        ...
        public object ConvertFromString(string text, Type type)
        {
            try
            {
                ...
                if (type == typeof(Vector2))
                {
                    ...
                    return new Vector2(Convert.ToSingle(nums[0]), Convert.ToSingle(nums[1]));
                }
                if (type == typeof(Vector3))
                {
                    string[] nums = text.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
                    return new Vector3(Convert.ToSingle(nums[0]), Convert.ToSingle(nums[1]), Convert.ToSingle(nums[2]));
                }
